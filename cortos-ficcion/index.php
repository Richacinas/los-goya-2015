				...
				<section>
					<div id="img-cab-portada" class="img-section-cab img-main-section">
						...
						<div class="column-center" style="witdh=80%; height: 100px; position:absolute; bottom:80px; display:block;">
							<p class="articulo19" style="color:white;">Me llamo Juana y acabo de salir de la Universidad. Mi objetivo es conseguir una nominación a los Goya. Esta es la historia de cómo me he embarcado en esta aventura tras charlar con los nominados a Mejor Corto de Ficción de este año. Pincha en su foto para ver el tráiler de su cortometraje.</p>
						</div>
					</div>
				</section>
				<!-- Section 2 -->
			...
			<section id="perfiles" class="main-section">
				...
				<section>
					...
					<div class="text-section" style="height: 200px;">
						<div class="article">
							<div class="column-center" style="height: 180px;">
								<p class="articulo19" style="margin-left:25px; margin-right:75px;margin-top:50px;">Pero, ¿quién está detrás de Café para llevar, Loco con Ballesta, Safari, Trato Preferente y Todo un futuro juntos?  Pues el perfil de la mayoría de ellos no se asemeja mucho al mío: yo tengo solamente 22 años, soy mujer y mi experiencia en el mundo audiovisual es muy limitada. La mayoría de los nominados son hombres de entre 30 y 45 años que ya tienen su recorrido en el sector y han ganado algún que otro premio. Y yo con toda mi cara, recién salida de la universidad, planteándome hacer un corto capaz de llegar a ese nivel. Os voy a hablar un poco de ellos, para que os hagáis una idea de cómo es el panorama:</p>
							</div>
						</div>
					</div>
					<div class="text-section" style="height: 400px;">
						<div class="article">
							<div class="column-left" style="height: 510px; margin-top:0px">
								<p class="articulo16" style="margin-left :25px; margin-bottom:0px; margin-top:0px; margin-right:70px;"><strong>Patricia Font (Café para llevar)</strong> lleva desde que se graduó en la ESCAC encadenando rodajes de diferentes producciones de cine y TV. Incluso ha dirigido varios capítulos de <a href="http://www.ccma.cat/tv3/polseres-vermelles/" target="_blank">Pulseras Rojas</a>(2011-...). Fue en una cafetería cuando me confesó que tan contento se quedó Pau Freixas -el creador de Pulseras Rojas- que actualmente Patricia y él están trabajando en una nueva serie juntos.</p>
								<p class="articulo16" style="margin-left :25px; margin-bottom:0px; margin-top:20px; margin-right:70px;">También <strong>Gerardo Herrero (Safari)</strong> y <strong>Pablo Remón (Todo un futuro juntos)</strong> estudiaron en otra prestigiosa escuela: la ECAM. Gerardo tiene su propia productora, <a href="http://gerardoherrero.com/" target="_blank">Dynamite Films</a>, con la que ha hecho cortos como <a href="http://festivaldemalaga.com/el-festival/ediciones" target="_blank">Picnic</a> (2010) o The Acrobat (2013); Pablo, además de director es guionista y dramaturgo - ha escrito una obra de teatro, La abducción de Luis Guzmán (2013). Entre sus guiones figuran, Casual Day (2007) o Cinco metros cuadrados (2011)-. Cuando quedé con Pablo en su despacho, pude comprobar que actualmente tiene varios proyectos encima de la mesa.</p>
							</div>
							<div class="column-text" style="width:530px; height:400px;">
								<p class="articulo16" style="margin-left :0px; margin-bottom:0px; margin-top:0px; margin-right:70px;"><strong>Carlos Polo (Trato preferente)</strong> ha hecho prácticamente de todo en el mundo audiovisual: ficción, diseño web, campañas publicitarias para Internet... En la oficina donde trabaja me llegó a enseñar una de sus joyas: ¡un spot interactivo! Con su anterior corto, <a href="http://vimeo.com/11488967" target="_blank">Paganini 2015</a>, consiguió ser finalista en el Festival NotodoFilmFest en 2010.</p>
								<p class="articulo16" style="margin-left :0px; margin-bottom:0px; margin-top:20px; margin-right:70px;">¡Qué decir de <strong>Kepa Sojo (Loco con ballesta)</strong>! Es profesor de Historia del Cine en la Universidad del País Vasco y se encarga de organizar el <a href="http://www.festivalcortada.com/" target="_blank">Festival de Cortos Cortada de Vitoria</a>. También ha dirigido una película, El síndrome Svensson (2009), ¡y entre todo eso ha sacado tiempo para reclutar a Karra Elejalde para Loco con Ballesta!</p>
					...
					<div class="text-section" style="height:350px;">
						<div class="article">
							<div class="column-text" style="height:730px;">
								<p class="articulo19" style="margin-left :25px; margin-bottom:0px; margin-top:60px; margin-right:70px;">Pues bien, aquí me encuentro, con mi cortometraje en distribución esperando ansiosa ser llamada de algún festival, algo que me confirme que mi corto ha llegado a buen puerto, que merece la pena ser visto y que tengo alguna posibilidad de ser nominada a los Goya, por muy remota que sea.</p>
							</div>
							<div class="column-text" style="height:730px;">
								<p class="articulo19" style="margin-left :0px; margin-bottom:0px; margin-top:60px; margin-right:70px;">Aun así, muchas veces cuando muestro mi ilusión por poder estar entre los seleccionados, hay gente que me mira raro, como preguntándose <strong>para qué sirve ganar un Goya</strong>. Pues desde 2008, todos los ganadores, excepto uno, han conseguido seguir dedicándose al audiovisual, y no de cualquier manera, sino que la mayoría han realizado su propia película. ¡Un largo! En cuanto a los nominados que no se llevaron el cabezudo a casa tampoco les ha ido mucho peor.</p>
							</div>
						</div>
					</div>
				</section>
