					...
					<div class="text-section" style="height: 1300px;">
						<div class="article">
							<div class="column-left" style="height: 510px; margin-top:0px">
								<p class="articulo14" style="margin-left :25px; margin-bottom:0px; margin-top:40px;"><strong>Por Estefanía de Antonio</strong></p>
								<p class="articulo16" style="margin-left :25px; margin-bottom:0px; margin-top:20px; margin-right:70px;">Apenas quedaban dos minutos para los ocho de la mañana del 26 de diciembre de 2004 cuando <strong>la tierra tembló a 3.000 metros de profundidad en el Oceáno Índico</strong>, a 120 kilómetros al oeste de Sumatra. Fue el último amanecer para 230.000 personas.</p>
								<p class="articulo16" style="margin-left :25px; margin-bottom:0px; margin-top:20px; margin-right:70px;">El tsunami arrasó las paradisíacas costas de Tailandia, Indonesia, La India, Sri Lanka y otros archipiélagos del sureste asiático.</p>
								<p class="articulo19" style="margin-left :25px; margin-bottom:0px; margin-top:20px; margin-right:70px;"><strong>El terremoto de Sumatra-Andamán es el tercer seísmo más grande registrado en la historia y el más duradero, entre 8 y 10 minutos.</strong></p>
								<p class="articulo16" style="margin-left :25px; margin-bottom:0px; margin-top:20px; margin-right:70px;">De intensidad 9,3 en la escala Richter, <strong>liberó la  energía de 23.000 bombas atómicas como la de Hiroshima</strong>, una potencia suficiente como para hacer que el planeta vibrara un centímetro. Olas de hasta 20 metros viajaron por el océano a 700 kilómetros por hora, la velocidad de un avión a reacción.  Las más pequeñas llegaron a 5.000 kilómetros del epicentro, hasta Somalia.</p>
							</div>
					...
					<div class="text-section" style="height: 300px;">
						<div class="article">
							<div class="column-center" style="height: 250px;">
								<p class="articulo19" style="margin-left:25px; margin-right:25px;"><strong>Después de vivir el tsunami, tengo sentimientos encontrados</strong>. Por una parte recuerdo la gente se encerró en sí misma aquellas horas, y por otra parte recuerdo todos aquellos que a pesar de que habían perdido todo, o de estar muertos de miedo, intentaron hacer la vida de los que les rodeaban mejor.</p>
								<p class="articulo16" style="font-size:25px;margin-left:25px; margin-right:25px;margin-top:50px;"><strong>Supongo que no se puede juzgar, yo no vi la ola y no sentí ese miedo, quizás hubiera reaccionado de otra manera de haberlo vivido como el resto. No he vuelto a bucear, no sé si volveré a hacerlo."</strong></p>
							</div>
						</div>
					</div>
				</section>
