...
<div class="content">
    <div class="stage">
      <div itemscope itemtype="http://schema.org/ImageObject">
        <div class="foto">
            <img id="carousel-image" title="<?php echo $aCarousel[$carouselIndex ][2]; ?> en los Oscar 2015 - RTVE.es" src="" data-zoom-image="<?php echo $baseUrl; ?>fotosPublished/zoom/<?php echo $aCarousel[$carouselIndex ][1]; ?>?t=<?php echo date_timestamp_get($fecha); ?>" alt="<?php echo $aCarousel[$carouselIndex ][2]; ?> en los Oscar 2015" itemprop="image" />
        </div>
        <div class="txt">
